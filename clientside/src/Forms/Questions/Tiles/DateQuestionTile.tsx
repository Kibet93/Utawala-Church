...
@observer
export class DateQuestionTileOptions extends Component<QuestionTileOptionsProps> {
...
export interface IDateQuestionTileProps<T> extends QuestionComponentProps<T> {
	// % protected region % [Add extra props here] off begin
	// % protected region % [Add extra props here] end
}

@observer
export class DateQuestionTile<T> extends QuestionComponent<T, IDateQuestionTileProps<T>> implements IQuestionTile {
	// % protected region % [Customize static form vars here] off begin
	static displayName = 'Date';

	static questionType: QuestionType = 'date';

	static optionsMenu = DateQuestionTileOptions;
