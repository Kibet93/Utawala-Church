...
export interface IUsherEntityAttributes extends IModelAttributes {
	email: string;
	memberID: number;
...
@entity('UsherEntity', 'Usher')
// % protected region % [Customise your entity metadata here] end
export default class UsherEntity extends Model implements IUsherEntityAttributes {
	...
	@Validators.Custom('Password Match', (e: string, target: UsherEntity) => {
	...
	constructor(attributes?: Partial<IUsherEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IUsherEntityAttributes>) {
...
CRUD(createdAttr)(UsherEntity.prototype, 'created');
CRUD(modifiedAttr)(UsherEntity.prototype, 'modified');
