...
export interface IAttendanceEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.AttendanceEntity | Models.IAttendanceEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('AttendanceEntityFormTileEntity', 'Attendance Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class AttendanceEntityFormTileEntity extends Model implements IAttendanceEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'AttendanceEntity',
	...
	public form: Models.AttendanceEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	// eslint-disable-next-line @typescript-eslint/no-useless-constructor
	constructor(attributes?: Partial<IAttendanceEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IAttendanceEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form !== undefined) {
				if (attributes.form === null) {
					...
					if (attributes.form instanceof Models.AttendanceEntity) {
						this.form = attributes.form;
						this.formId = attributes.form.id;
					} else {
						this.form = new Models.AttendanceEntity(attributes.form);
	...
	public defaultExpands = `
		form {
			${Models.AttendanceEntity.getAttributes().join('\n')}
		}
	`;
...
CRUD(createdAttr)(AttendanceEntityFormTileEntity.prototype, 'created');
CRUD(modifiedAttr)(AttendanceEntityFormTileEntity.prototype, 'modified');
