...
export interface IMemberEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.MemberEntity | Models.IMemberEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('MemberEntityFormTileEntity', 'MEMBER Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class MemberEntityFormTileEntity extends Model implements IMemberEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'MemberEntity',
	...
	public form: Models.MemberEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	// eslint-disable-next-line @typescript-eslint/no-useless-constructor
	constructor(attributes?: Partial<IMemberEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IMemberEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form !== undefined) {
				if (attributes.form === null) {
					...
					if (attributes.form instanceof Models.MemberEntity) {
						this.form = attributes.form;
						this.formId = attributes.form.id;
					} else {
						this.form = new Models.MemberEntity(attributes.form);
...
CRUD(createdAttr)(MemberEntityFormTileEntity.prototype, 'created');
CRUD(modifiedAttr)(MemberEntityFormTileEntity.prototype, 'modified');
