...
import { VisitorsCategoryLeadersEntity } from 'Models/Security/Acl/VisitorsCategoryLeadersEntity';
import { AdminCategoryLeadersEntity } from 'Models/Security/Acl/AdminCategoryLeadersEntity';
import { MembersCategoryLeadersEntity } from 'Models/Security/Acl/MembersCategoryLeadersEntity';
import { CategoryLeadersCategoryLeadersEntity } from 'Models/Security/Acl/CategoryLeadersCategoryLeadersEntity';
import { UsherCategoryLeadersEntity } from 'Models/Security/Acl/UsherCategoryLeadersEntity';
import { ProtocolCategoryLeadersEntity } from 'Models/Security/Acl/ProtocolCategoryLeadersEntity';
...
export interface ICategoryLeadersEntityAttributes extends IModelAttributes {
	email: string;
	categoryGroup: Enums.categoryGroups;
...
@entity('CategoryLeadersEntity', 'Category Leaders')
// % protected region % [Customise your entity metadata here] end
export default class CategoryLeadersEntity extends Model implements ICategoryLeadersEntityAttributes {
	...
	@Validators.Custom('Password Match', (e: string, target: CategoryLeadersEntity) => {
	...
	// % protected region % [Modify props to the crud options here for attribute 'Category Group'] off begin
	@observable
	@attribute()
	@CRUD({
		name: 'Category Group',
	...
	public categoryGroup: Enums.categoryGroups;
	// % protected region % [Modify props to the crud options here for attribute 'Category Group'] end
	...
	constructor(attributes?: Partial<ICategoryLeadersEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ICategoryLeadersEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.categoryGroup !== undefined) {
				this.categoryGroup = attributes.categoryGroup;
			}
...
CRUD(createdAttr)(CategoryLeadersEntity.prototype, 'created');
CRUD(modifiedAttr)(CategoryLeadersEntity.prototype, 'modified');
