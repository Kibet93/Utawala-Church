...
import { VisitorsMemberSubmission } from 'Models/Security/Acl/VisitorsMemberSubmission';
import { AdminMemberSubmission } from 'Models/Security/Acl/AdminMemberSubmission';
import { MemberMemberSubmission } from 'Models/Security/Acl/MemberMemberSubmission';
import { CategoryGroupLeaderMemberSubmission } from 'Models/Security/Acl/CategoryGroupLeaderMemberSubmission';
import { UsherMemberSubmission } from 'Models/Security/Acl/UsherMemberSubmission';
import { ProtocolMemberSubmission } from 'Models/Security/Acl/ProtocolMemberSubmission';
import { GroupCategoryMemberSubmission } from 'Models/Security/Acl/GroupCategoryMemberSubmission';
...
export interface IMemberSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('MemberSubmissionEntity', 'MEMBER Submission')
// % protected region % [Customise your entity metadata here] end
export default class MemberSubmissionEntity extends Model implements IMemberSubmissionEntityAttributes {
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as MemberSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IMemberSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IMemberSubmissionEntityAttributes>) {
...
CRUD(createdAttr)(MemberSubmissionEntity.prototype, 'created');
CRUD(modifiedAttr)(MemberSubmissionEntity.prototype, 'modified');
