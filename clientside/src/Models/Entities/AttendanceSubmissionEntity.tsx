...
import { VisitorsAttendanceSubmission } from 'Models/Security/Acl/VisitorsAttendanceSubmission';
import { AdminAttendanceSubmission } from 'Models/Security/Acl/AdminAttendanceSubmission';
import { MembersAttendanceSubmission } from 'Models/Security/Acl/MembersAttendanceSubmission';
import { CategoryLeadersAttendanceSubmission } from 'Models/Security/Acl/CategoryLeadersAttendanceSubmission';
import { UsherAttendanceSubmission } from 'Models/Security/Acl/UsherAttendanceSubmission';
import { ProtocolAttendanceSubmission } from 'Models/Security/Acl/ProtocolAttendanceSubmission';
...
export interface IAttendanceSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('AttendanceSubmissionEntity', 'Attendance Submission')
// % protected region % [Customise your entity metadata here] end
export default class AttendanceSubmissionEntity extends Model implements IAttendanceSubmissionEntityAttributes {
	...
	@CRUD({
		...
		referenceTypeFunc: () => Models.AttendanceEntity,
		displayFunction: (attr, that) => (that as AttendanceSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IAttendanceSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IAttendanceSubmissionEntityAttributes>) {
...
CRUD(createdAttr)(AttendanceSubmissionEntity.prototype, 'created');
CRUD(modifiedAttr)(AttendanceSubmissionEntity.prototype, 'modified');
