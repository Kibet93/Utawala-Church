	...
	public render() {
			...
			<div className="body-content">
				<form className="register register-user-type">
					...
					<ButtonGroup alignment={Alignment.HORIZONTAL} className="select-type-buttons">
						<Button className="confirm-type btn--primary" display={Display.Solid} sizes={Sizes.Medium} buttonProps={{ id: "confirm_type" }} onClick={this.onTypeConfirmed}>Confirm</Button>
						<Button className="cancel-register" display={Display.Solid} colors={Colors.Secondary} sizes={Sizes.Medium} buttonProps={{ id: "cancel_register" }} onClick={this.onCancelRegisterClicked}>Cancel</Button>
					</ButtonGroup>
				</form>
			</div>
		);
			...
			<div className="body-content">
				<form className="register" onSubmit={this.onSubmitRegisterClicked}>
					<If condition={this.registerableEntities.length > 1}>
						<Button display={Display.Text} className='change-user-type icon-chevron-left icon-left' onClick={this.onChangeUserType}>Change User Type</Button>
					</If>
					<h2>Registration</h2>
					...
					<ButtonGroup alignment={Alignment.HORIZONTAL} className="register-buttons">
						<Button type='submit' className="submit-register  btn--primary" display={Display.Solid} sizes={Sizes.Medium} buttonProps={{ id: "submit_register" }}>Register</Button>
		...
		const emailSentMessageNode = (
			<div className="registration registration-success">
				...
				<Button display={Display.Solid} sizes={Sizes.Large} className="login-link btn btn--primary" onClick={this.onLoginClick}>Login</Button>
			</div>
		);
