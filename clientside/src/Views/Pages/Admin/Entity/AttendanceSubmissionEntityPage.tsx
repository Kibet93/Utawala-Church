...
@observer
export default class AttendanceSubmissionEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.AttendanceSubmissionEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
		...
		return (
			<SecuredPage groups={["Super Administrators", "Visitors","Admin","Members","CategoryLeaders","Usher","Protocol"]}>
				{contents}
			</SecuredPage>
		);
	}
