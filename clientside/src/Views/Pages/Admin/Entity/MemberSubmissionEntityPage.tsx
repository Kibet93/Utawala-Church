...
@observer
export default class MemberSubmissionEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.MemberSubmissionEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
		...
		return (
			<SecuredPage groups={["Super Administrators", "Visitors","Admin","Member","CategoryGroupLeader","Usher","Protocol","GroupCategory"]}>
				{contents}
			</SecuredPage>
		);
	}
