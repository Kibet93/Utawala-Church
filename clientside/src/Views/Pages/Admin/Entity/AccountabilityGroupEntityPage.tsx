...
@observer
export default class AccountabilityGroupEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.AccountabilityGroupEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
		...
		return (
			<SecuredPage groups={["Super Administrators", "Admin","Member","CategoryGroupLeader","Protocol"]}>
				{contents}
			</SecuredPage>
		);
	}
