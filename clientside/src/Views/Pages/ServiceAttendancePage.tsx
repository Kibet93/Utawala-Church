...
import { ServicesEntity } from 'Models/Entities';
...
export interface ServiceAttendancePageProps extends RouteComponentProps {
...
class ServiceAttendancePage extends React.Component<ServiceAttendancePageProps> {
		...
		let contents = (
			<SecuredPage groups={['Super Administrators', 'Admin', 'Members', 'CategoryLeaders', 'Usher', 'Protocol']}>
				...
				<div className="body-content">
					...
					<EntityCRUD
						{...this.props}
						modelType={ServicesEntity}
						URLExtension="24654ee3-a79b-4cbe-822e-b01f631ee946"
						// % protected region % [Add props to crud component 24654ee3-a79b-4cbe-822e-b01f631ee946 here] off begin
						// % protected region % [Add props to crud component 24654ee3-a79b-4cbe-822e-b01f631ee946 here] end
					/>
				</div>
			</SecuredPage>
		);
