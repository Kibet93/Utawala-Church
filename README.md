...
**Bot version:** 2.4.0.0 ([Release notes are here](https://forum.codebots.com/t/c-bot-release-2-4-0-0))
...
`<DbConnectionString>Server=localhost;Database=Utawalaaltar;Username=postgres;Password=pass;</DbConnectionString>`
...
```shell
docker build -t Utawalaaltar:1.0.0 .
```
...
```shell
docker run --env-file ./docker.env --publish 80:80 Utawalaaltar:1.0.0
```
...
* Configuration for the Workflow Extension
...
Your app is using: [Forms](https://codebots.com/docs/forms-extension-overview), [Workflow](https://codebots.com/docs/workflow-extension-overview), [User](https://codebots.com/docs/user-extension-overview)

You aren't using: [Timeline](https://codebots.com/docs/timelines-extension-overview)
