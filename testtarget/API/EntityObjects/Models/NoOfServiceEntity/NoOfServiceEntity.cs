...
{
	public class NoOfServiceEntity : BaseEntity
	{
		// 
		[Unique]
		[EntityAttribute]
		...
		public NoOfServiceEntity()
		{
			EntityName = "NoOfServiceEntity";
			InitialiseReferences();
		}

		public NoOfServiceEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<NoOfServiceEntity>()
		...
		public static NoOfServiceEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<NoOfServiceEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static NoOfServiceEntity GetValidEntity(string fixedStrValue = null)
		{
			var noOfServiceEntity = new NoOfServiceEntity
			{
			};
			noOfServiceEntity.PopulateAttributes();
