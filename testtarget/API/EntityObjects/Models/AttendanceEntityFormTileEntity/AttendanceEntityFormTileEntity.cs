...
{
	public class AttendanceEntityFormTileEntity : BaseEntity
	{
		...
		/// </summary>
		/// <see cref="Utawalaaltar.Models.Form"/>
		public Guid FormId { get; set; }


		public AttendanceEntityFormTileEntity()
		{
			EntityName = "AttendanceEntityFormTileEntity";
			InitialiseReferences();
		}

		public AttendanceEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<AttendanceEntityFormTileEntity>()
		...
		public static AttendanceEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<AttendanceEntityFormTileEntity>().entity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new AttendanceEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static AttendanceEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var attendanceEntityFormTileEntity = new AttendanceEntityFormTileEntity
			{
			};
			attendanceEntityFormTileEntity.PopulateAttributes();
			...
			return attendanceEntityFormTileEntity;
		}
