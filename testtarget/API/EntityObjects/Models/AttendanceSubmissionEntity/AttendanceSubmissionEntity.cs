...
{
	public class AttendanceSubmissionEntity : BaseEntity
	{


		public AttendanceSubmissionEntity()
		{
			EntityName = "AttendanceSubmissionEntity";
			InitialiseReferences();
		}

		public AttendanceSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<AttendanceSubmissionEntity>()
		...
		public static AttendanceSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<AttendanceSubmissionEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static AttendanceSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var attendanceSubmissionEntity = new AttendanceSubmissionEntity
			{
			};
			attendanceSubmissionEntity.PopulateAttributes();
