...
{
	public class MemberEntityFormTileEntity : BaseEntity
	{
		...
		public MemberEntityFormTileEntity()
		{
			EntityName = "MemberEntityFormTileEntity";
			InitialiseReferences();
		}

		public MemberEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<MemberEntityFormTileEntity>()
		...
		public static MemberEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<MemberEntityFormTileEntity>().entity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new MemberEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static MemberEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var memberEntityFormTileEntity = new MemberEntityFormTileEntity
			{
			};
			memberEntityFormTileEntity.PopulateAttributes();
			...
			return memberEntityFormTileEntity;
		}
