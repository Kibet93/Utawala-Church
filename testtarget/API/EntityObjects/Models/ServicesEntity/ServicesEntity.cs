...
namespace APITests.EntityObjects.Models
{
	public class ServicesEntity : BaseEntity
	{
		...
		{
			EntityName = "ServicesEntity";
			InitialiseReferences();
		}

		public ServicesEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<ServicesEntity>()
		...
		public static ServicesEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<ServicesEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static ServicesEntity GetValidEntity(string fixedStrValue = null)
		{
			var servicesEntity = new ServicesEntity
			{
			};
			servicesEntity.PopulateAttributes();
