...
{
	public class ProtocolEntity : UserBaseEntity 
	{
		// 
		[Unique]
		[EntityAttribute]
		...
		{
			EntityName = "ProtocolEntity";
			EndpointName = "protocol-entity";
			InitialiseReferences();
		}

		public ProtocolEntity(ConfigureOptions option)
		{
			EndpointName = "protocol-entity";
			Configure(option);
			InitialiseReferences();
		...
		{
			return GetInvalidEntities<ProtocolEntity>()
		...
		public static ProtocolEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<ProtocolEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static ProtocolEntity GetValidEntity(string fixedStrValue = null)
		{
			var protocolEntity = new ProtocolEntity
			{
			};
			protocolEntity.PopulateAttributes();
