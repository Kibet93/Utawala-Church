...
{
	public class UsherEntity : UserBaseEntity 
	{
		// 
		[EntityAttribute]
		...
		public UsherEntity()
		{
			EntityName = "UsherEntity";
			EndpointName = "usher-entity";
			InitialiseReferences();
		}

		public UsherEntity(ConfigureOptions option)
		{
			EndpointName = "usher-entity";
			Configure(option);
			InitialiseReferences();
		...
		{
			return GetInvalidEntities<UsherEntity>()
		...
		public static UsherEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<UsherEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static UsherEntity GetValidEntity(string fixedStrValue = null)
		{
			var usherEntity = new UsherEntity
			{
			};
			usherEntity.PopulateAttributes();
