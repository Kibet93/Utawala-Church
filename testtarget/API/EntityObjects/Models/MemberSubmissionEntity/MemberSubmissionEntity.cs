...
{
	public class MemberSubmissionEntity : BaseEntity
	{


		public MemberSubmissionEntity()
		{
			EntityName = "MemberSubmissionEntity";
			InitialiseReferences();
		}

		public MemberSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<MemberSubmissionEntity>()
		...
		public static MemberSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<MemberSubmissionEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static MemberSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var memberSubmissionEntity = new MemberSubmissionEntity
			{
			};
			memberSubmissionEntity.PopulateAttributes();
