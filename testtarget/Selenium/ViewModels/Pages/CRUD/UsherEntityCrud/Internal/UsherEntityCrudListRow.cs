...
{
	public class UsherEntityCrudListRow : Component, ICrudListRow
	{
		...
		public UsherEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
