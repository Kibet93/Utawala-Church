...
{
	public class AttendanceEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AttendanceEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
