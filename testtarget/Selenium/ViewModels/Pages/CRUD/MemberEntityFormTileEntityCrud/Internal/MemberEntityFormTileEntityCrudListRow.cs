...
{
	public class MemberEntityFormTileEntityCrudListRow : Component, ICrudListRow
	{
		...
		public MemberEntityFormTileEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
