...
{
	public class GroupCategoryEntityCrudListRow : Component, ICrudListRow
	{
		...
		public GroupCategoryEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
