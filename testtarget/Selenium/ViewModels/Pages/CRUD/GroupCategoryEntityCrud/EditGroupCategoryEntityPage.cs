...
{
	public class EditGroupCategoryEntityPage : GroupCategoryEntityAttributeCollection
	{
		...
		public EditGroupCategoryEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
