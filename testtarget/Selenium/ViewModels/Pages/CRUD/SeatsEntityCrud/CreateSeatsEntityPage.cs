...
{
	public class CreateSeatsEntityPage : SeatsEntityAttributeCollection
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/seatsEntity/create";
		public CrudCreateButtons ActionButtons => new(ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CreateSeatsEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
		...
		public void SetValues(SeatsEntity seatsEntity)
		{
			SeatNumber.Value = seatsEntity.SeatNumber.ToString();
			Reservation.Value = seatsEntity.Reservation.ToString();
			WorkflowStatesIds.Value = seatsEntity.WorkflowStatesIds?.Select(x => x.ToString());
		}
