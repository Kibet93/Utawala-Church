...
{
	public class SeatsEntityCrudListRow : Component, ICrudListRow
	{
		...
		public SeatsEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
