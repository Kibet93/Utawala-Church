...
{
	public class EditSeatsEntityPage : SeatsEntityAttributeCollection
	{
		...
		public EditSeatsEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
