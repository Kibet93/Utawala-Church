...
{
	public class AttendanceEntityFormTileEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AttendanceEntityFormTileEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
