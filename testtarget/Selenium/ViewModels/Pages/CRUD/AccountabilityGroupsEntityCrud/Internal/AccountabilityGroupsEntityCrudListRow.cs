...
{
	public class AccountabilityGroupsEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AccountabilityGroupsEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
