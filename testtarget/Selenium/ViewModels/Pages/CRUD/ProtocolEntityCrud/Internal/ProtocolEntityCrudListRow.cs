...
{
	public class ProtocolEntityCrudListRow : Component, ICrudListRow
	{
		...
		public ProtocolEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
