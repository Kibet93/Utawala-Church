...
{
	public class MemberEntityCrudListRow : Component, ICrudListRow
	{
		...
		public MemberEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
