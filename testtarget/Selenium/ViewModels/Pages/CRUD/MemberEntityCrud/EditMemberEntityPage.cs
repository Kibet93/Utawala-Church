...
{
	public class EditMemberEntityPage : MemberEntityAttributeCollection
	{
		...
		public EditMemberEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
