...
{
	public class CategoryLeadersEntityCrudListRow : Component, ICrudListRow
	{
		...
		public CategoryLeadersEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
