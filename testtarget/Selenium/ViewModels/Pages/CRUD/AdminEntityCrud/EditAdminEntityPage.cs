...
{
	public class EditAdminEntityPage : AdminEntityAttributeCollection
	{
		...
		public EditAdminEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
