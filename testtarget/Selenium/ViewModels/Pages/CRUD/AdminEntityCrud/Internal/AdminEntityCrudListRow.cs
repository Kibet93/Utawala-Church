...
{
	public class AdminEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AdminEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
