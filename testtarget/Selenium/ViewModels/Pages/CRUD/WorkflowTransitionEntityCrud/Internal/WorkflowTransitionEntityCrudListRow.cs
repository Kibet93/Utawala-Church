...
{
	public class WorkflowTransitionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public WorkflowTransitionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
