...
{
	public class EditNoOfServiceEntityPage : NoOfServiceEntityAttributeCollection
	{
		...
		public EditNoOfServiceEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
