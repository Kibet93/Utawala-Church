...
{
	public class NoOfServiceEntityCrudListRow : Component, ICrudListRow
	{
		...
		public NoOfServiceEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
