...
{
	public class NoOfServiceEntityAttributeCollection : Page
	{
		...
		public NoOfServiceEntityAttributeCollection(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
