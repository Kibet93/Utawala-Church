...
{
	public class CreateNoOfServiceEntityPage : NoOfServiceEntityAttributeCollection
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/noOfServiceEntity/create";
		public CrudCreateButtons ActionButtons => new(ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CreateNoOfServiceEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
		...
		public void SetValues(NoOfServiceEntity noOfServiceEntity)
		{
			Name.Value = noOfServiceEntity.Name;
			Status.Value = noOfServiceEntity.Status.ToString();
		}
