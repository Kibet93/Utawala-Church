...
{
	public class ServicesEntityCrudListRow : Component, ICrudListRow
	{
		...
		public ServicesEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
