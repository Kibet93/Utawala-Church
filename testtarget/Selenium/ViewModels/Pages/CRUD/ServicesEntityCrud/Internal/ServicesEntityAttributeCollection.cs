...
{
	public class ServicesEntityAttributeCollection : Page
	{
		...
		public ServicesEntityAttributeCollection(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
