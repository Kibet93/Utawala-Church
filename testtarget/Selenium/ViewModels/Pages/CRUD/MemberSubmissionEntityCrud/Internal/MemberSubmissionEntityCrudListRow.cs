...
{
	public class MemberSubmissionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public MemberSubmissionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
