...
namespace SeleniumTests.ViewModels.Pages.CRUD.CategoryGroupLeaderEntityCrud.Internal
{
	public class CategoryGroupLeaderEntityAttributeCollection : Page
	{
		...
		public AttributeTextField GroupName => new(By.CssSelector("div.groupName"), ContextConfiguration);
		public AttributeReferenceCombobox GroupCategoryId => new(By.CssSelector("div.groupCategoryId"), ContextConfiguration);
		public AttributeReferenceCombobox MemberId => new(By.CssSelector("div.memberId"), ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CategoryGroupLeaderEntityAttributeCollection(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
