...
{
	public class CategoryGroupLeaderEntityCrudListRow : Component, ICrudListRow
	{
		...
		public CategoryGroupLeaderEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
