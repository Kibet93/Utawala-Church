...
{
	public class EditCategoryGroupLeaderEntityPage : CategoryGroupLeaderEntityAttributeCollection
	{
		...
		public EditCategoryGroupLeaderEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
