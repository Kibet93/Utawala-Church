...
{
	public class WorkflowVersionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public WorkflowVersionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
