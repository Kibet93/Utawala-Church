...
{
	public class EditWorkflowVersionEntityPage : WorkflowVersionEntityAttributeCollection
	{
		...
		public EditWorkflowVersionEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
