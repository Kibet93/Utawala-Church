...
{
	public class AttendanceSubmissionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AttendanceSubmissionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
