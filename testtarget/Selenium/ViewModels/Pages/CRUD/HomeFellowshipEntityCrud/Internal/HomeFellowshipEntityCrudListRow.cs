...
{
	public class HomeFellowshipEntityCrudListRow : Component, ICrudListRow
	{
		...
		public HomeFellowshipEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
