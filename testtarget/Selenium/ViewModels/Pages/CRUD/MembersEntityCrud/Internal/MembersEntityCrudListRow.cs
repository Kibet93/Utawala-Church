...
{
	public class MembersEntityCrudListRow : Component, ICrudListRow
	{
		...
		public MembersEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
