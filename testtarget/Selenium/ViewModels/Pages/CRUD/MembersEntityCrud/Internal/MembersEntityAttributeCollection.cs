...
namespace SeleniumTests.ViewModels.Pages.CRUD.MembersEntityCrud.Internal
{
	public class MembersEntityAttributeCollection : Page
	{
		...
		public AttributeEnumCombobox CategoryChoice => new(By.CssSelector("div.categoryChoice"), ContextConfiguration);
		public AttributeTextField AccountabilityGrp => new(By.CssSelector("div.accountabilityGrp"), ContextConfiguration);
		public AttributeFileUpload Picture => new(By.CssSelector("div.pictureId"), ContextConfiguration);
		...
		public MembersEntityAttributeCollection(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
