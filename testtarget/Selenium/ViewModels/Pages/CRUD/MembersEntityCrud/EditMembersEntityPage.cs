...
{
	public class EditMembersEntityPage : MembersEntityAttributeCollection
	{
		...
		public EditMembersEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
