...
{
	public class WorkflowEntityCrudListRow : Component, ICrudListRow
	{
		...
		public WorkflowEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
