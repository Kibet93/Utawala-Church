...
{
	public class AccountabilityGroupEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AccountabilityGroupEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
