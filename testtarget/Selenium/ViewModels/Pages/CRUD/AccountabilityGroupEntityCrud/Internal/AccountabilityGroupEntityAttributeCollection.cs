...
{
	public class AccountabilityGroupEntityAttributeCollection : Page
	{
		...
		public AccountabilityGroupEntityAttributeCollection(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
