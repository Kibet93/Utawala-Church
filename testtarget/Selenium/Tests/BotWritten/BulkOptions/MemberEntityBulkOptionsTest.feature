...
Feature: MemberEntity Bulk Option Selection
...
@MemberEntity
Scenario: Select all MemberEntitys on current page
...
@MemberEntity
Scenario: I attempt to select all MemberEntitys on all pages
Given I login to the site as a user
And I navigate to the MemberEntity backend page
When I select all entities on current page
