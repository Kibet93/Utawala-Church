...
Feature: CategoryLeadersEntity Bulk Option Selection
...
Scenario: Select all CategoryLeadersEntitys on current page
...
@CategoryLeadersEntity
Scenario: I attempt to select all CategoryLeadersEntitys on all pages
Given I login to the site as a user
And I navigate to the CategoryLeadersEntity backend page
When I select all entities on current page
