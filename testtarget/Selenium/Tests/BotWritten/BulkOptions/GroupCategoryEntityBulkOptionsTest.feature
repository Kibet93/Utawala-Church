...
Feature: GroupCategoryEntity Bulk Option Selection
...
@GroupCategoryEntity
Scenario: Select all GroupCategoryEntitys on current page
...
@GroupCategoryEntity
Scenario: I attempt to select all GroupCategoryEntitys on all pages
Given I login to the site as a user
And I navigate to the GroupCategoryEntity backend page
When I select all entities on current page
