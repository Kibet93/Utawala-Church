...
Feature: ServicesEntity Bulk Option Selection
...
@ServicesEntity
Scenario: Select all ServicesEntitys on current page
...
@ServicesEntity
Scenario: I attempt to select all ServicesEntitys on all pages
Given I login to the site as a user
And I navigate to the ServicesEntity backend page
When I select all entities on current page
