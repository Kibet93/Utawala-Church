...
Feature: HomeFellowshipEntity Bulk Option Selection
...
Scenario: Select all HomeFellowshipEntitys on current page
...
@HomeFellowshipEntity
Scenario: I attempt to select all HomeFellowshipEntitys on all pages
Given I login to the site as a user
And I navigate to the HomeFellowshipEntity backend page
When I select all entities on current page
