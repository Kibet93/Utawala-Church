...
Feature: AccountabilityGroupsEntity Bulk Option Selection
...
Scenario: Select all AccountabilityGroupsEntitys on current page
...
@AccountabilityGroupsEntity
Scenario: I attempt to select all AccountabilityGroupsEntitys on all pages
Given I login to the site as a user
And I navigate to the AccountabilityGroupsEntity backend page
When I select all entities on current page
