...
Feature: ProtocolEntity Bulk Option Selection
...
@ProtocolEntity
Scenario: Select all ProtocolEntitys on current page
...
@ProtocolEntity
Scenario: I attempt to select all ProtocolEntitys on all pages
Given I login to the site as a user
And I navigate to the ProtocolEntity backend page
When I select all entities on current page
