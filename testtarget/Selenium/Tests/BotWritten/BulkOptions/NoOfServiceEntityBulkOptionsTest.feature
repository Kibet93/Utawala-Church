...
Feature: NoOfServiceEntity Bulk Option Selection
...
@NoOfServiceEntity
Scenario: Select all NoOfServiceEntitys on current page
...
@NoOfServiceEntity
Scenario: I attempt to select all NoOfServiceEntitys on all pages
Given I login to the site as a user
And I navigate to the NoOfServiceEntity backend page
When I select all entities on current page
