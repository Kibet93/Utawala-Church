...
Feature: AccountabilityGroupEntity Bulk Option Selection
...
Scenario: Select all AccountabilityGroupEntitys on current page
...
@AccountabilityGroupEntity
Scenario: I attempt to select all AccountabilityGroupEntitys on all pages
Given I login to the site as a user
And I navigate to the AccountabilityGroupEntity backend page
When I select all entities on current page
