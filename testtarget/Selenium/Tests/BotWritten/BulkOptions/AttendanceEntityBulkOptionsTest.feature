...
Feature: AttendanceEntity Bulk Option Selection
...
@AttendanceEntity
Scenario: Select all AttendanceEntitys on current page
...
@AttendanceEntity
Scenario: I attempt to select all AttendanceEntitys on all pages
Given I login to the site as a user
And I navigate to the AttendanceEntity backend page
When I select all entities on current page
