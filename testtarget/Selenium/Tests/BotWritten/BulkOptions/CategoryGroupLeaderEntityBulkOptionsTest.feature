...
Feature: CategoryGroupLeaderEntity Bulk Option Selection
...
Scenario: Select all CategoryGroupLeaderEntitys on current page
...
@CategoryGroupLeaderEntity
Scenario: I attempt to select all CategoryGroupLeaderEntitys on all pages
Given I login to the site as a user
And I navigate to the CategoryGroupLeaderEntity backend page
When I select all entities on current page
