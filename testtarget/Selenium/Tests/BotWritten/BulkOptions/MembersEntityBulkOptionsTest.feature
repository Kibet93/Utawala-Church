...
Feature: MembersEntity Bulk Option Selection
...
@MembersEntity
Scenario: Select all MembersEntitys on current page
...
@MembersEntity
Scenario: I attempt to select all MembersEntitys on all pages
Given I login to the site as a user
And I navigate to the MembersEntity backend page
When I select all entities on current page
