...
@BotWritten @view
Feature: Admin Submenu CategoryLeadersEntity Feature
# % protected region % [Override feature properties here] end
	@CategoryLeadersEntity
	Scenario: I attempt to navigate to the CategoryLeadersEntity entity page
	...
	And I click the Category Leaders admin submenu
	Then I assert that I am on the Category Leaders Entity backend page
