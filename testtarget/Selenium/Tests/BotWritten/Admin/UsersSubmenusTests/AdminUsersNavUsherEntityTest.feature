...
@BotWritten @view
Feature: Admin Submenu UsherEntity Feature
# % protected region % [Override feature properties here] end
	@UsherEntity
	Scenario: I attempt to navigate to the UsherEntity entity page
	...
	And I click the Usher admin submenu
	Then I assert that I am on the Usher Entity backend page
