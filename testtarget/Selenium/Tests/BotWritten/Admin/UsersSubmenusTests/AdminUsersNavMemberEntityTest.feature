...
@BotWritten @view
Feature: Admin Submenu MemberEntity Feature
# % protected region % [Override feature properties here] end
	@MemberEntity
	Scenario: I attempt to navigate to the MemberEntity entity page
	...
	And I click the MEMBER admin submenu
	Then I assert that I am on the MEMBER Entity backend page
