...
@BotWritten @view
Feature: Admin Submenu CategoryGroupLeaderEntity Feature
# % protected region % [Override feature properties here] end
	@CategoryGroupLeaderEntity
	Scenario: I attempt to navigate to the CategoryGroupLeaderEntity entity page
	...
	And I click the Category Group Leader admin submenu
	Then I assert that I am on the Category Group Leader Entity backend page
