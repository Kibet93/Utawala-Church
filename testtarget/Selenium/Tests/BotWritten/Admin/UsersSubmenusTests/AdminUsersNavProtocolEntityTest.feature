...
@BotWritten @view
Feature: Admin Submenu ProtocolEntity Feature
# % protected region % [Override feature properties here] end
	@ProtocolEntity
	Scenario: I attempt to navigate to the ProtocolEntity entity page
	...
	And I click the Protocol admin submenu
	Then I assert that I am on the Protocol Entity backend page
