...
@BotWritten @view
Feature: Admin Submenu GroupCategoryEntity Feature
# % protected region % [Override feature properties here] end
	@GroupCategoryEntity
	Scenario: I attempt to navigate to the GroupCategoryEntity entity page
	...
	And I click the Group Category admin submenu
	Then I assert that I am on the Group Category Entity backend page
