...
@BotWritten @view
Feature: Admin Submenu MembersEntity Feature
# % protected region % [Override feature properties here] end
	@MembersEntity
	Scenario: I attempt to navigate to the MembersEntity entity page
	...
	And I click the MEMBERS admin submenu
	Then I assert that I am on the MEMBERS Entity backend page
