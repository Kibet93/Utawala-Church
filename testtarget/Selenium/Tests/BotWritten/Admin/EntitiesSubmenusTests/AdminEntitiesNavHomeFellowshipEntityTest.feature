...
Feature: Admin Submenu HomeFellowshipEntity
# % protected region % [Override feature properties here] end

	@HomeFellowshipEntity
	Scenario: Admin Submenu HomeFellowshipEntity
	...
	And I click the Home Fellowship admin submenu
	Then I assert that I am on the Home Fellowship Entity backend page