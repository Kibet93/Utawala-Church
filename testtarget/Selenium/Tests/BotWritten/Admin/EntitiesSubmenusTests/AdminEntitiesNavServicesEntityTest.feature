...
Feature: Admin Submenu ServicesEntity
# % protected region % [Override feature properties here] end

	@ServicesEntity
	Scenario: Admin Submenu ServicesEntity
	...
	And I click the Services admin submenu
	Then I assert that I am on the Services Entity backend page