...
Feature: Admin Submenu SeatsEntity
# % protected region % [Override feature properties here] end

	@SeatsEntity
	Scenario: Admin Submenu SeatsEntity
	...
	And I click the Seats admin submenu
	Then I assert that I am on the Seats Entity backend page