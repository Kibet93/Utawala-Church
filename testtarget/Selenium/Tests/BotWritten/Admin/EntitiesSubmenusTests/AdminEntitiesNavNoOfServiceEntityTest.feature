...
Feature: Admin Submenu NoOfServiceEntity
# % protected region % [Override feature properties here] end

	@NoOfServiceEntity
	Scenario: Admin Submenu NoOfServiceEntity
	...
	And I click the No Of Service admin submenu
	Then I assert that I am on the No Of Service Entity backend page