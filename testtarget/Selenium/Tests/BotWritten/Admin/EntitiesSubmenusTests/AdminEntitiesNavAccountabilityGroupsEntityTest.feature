...
Feature: Admin Submenu AccountabilityGroupsEntity
# % protected region % [Override feature properties here] end

	@AccountabilityGroupsEntity
	Scenario: Admin Submenu AccountabilityGroupsEntity
	...
	And I click the Accountability Groups admin submenu
	Then I assert that I am on the Accountability Groups Entity backend page