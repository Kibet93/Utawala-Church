...
Feature: Admin Submenu AccountabilityGroupEntity
# % protected region % [Override feature properties here] end

	@AccountabilityGroupEntity
	Scenario: Admin Submenu AccountabilityGroupEntity
	...
	And I click the Accountability Group admin submenu
	Then I assert that I am on the Accountability Group Entity backend page