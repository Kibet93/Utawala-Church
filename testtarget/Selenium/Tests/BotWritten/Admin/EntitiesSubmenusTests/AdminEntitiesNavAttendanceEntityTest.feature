...
Feature: Admin Submenu AttendanceEntity
# % protected region % [Override feature properties here] end

	@AttendanceEntity
	Scenario: Admin Submenu AttendanceEntity
	...
	And I click the Attendance admin submenu
	Then I assert that I am on the Attendance Entity backend page