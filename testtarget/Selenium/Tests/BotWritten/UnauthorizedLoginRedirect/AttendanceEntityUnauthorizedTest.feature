...
Feature: Unauthorized AttendanceEntity Redirect
# % protected region % [Override feature properties here] end

@AttendanceEntity
Scenario: Unauthorized AttendanceEntity Redirect
Given I am logged out of the site
And I navigate to the AttendanceEntity backend page
Then I assert that I am redirected from AttendanceEntity to login page
