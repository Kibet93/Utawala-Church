...
Feature: Unauthorized CategoryGroupLeaderEntity Redirect
# % protected region % [Override feature properties here] end

@CategoryGroupLeaderEntity
Scenario: Unauthorized CategoryGroupLeaderEntity Redirect
Given I am logged out of the site
And I navigate to the CategoryGroupLeaderEntity backend page
Then I assert that I am redirected from CategoryGroupLeaderEntity to login page
