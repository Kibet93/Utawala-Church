...
Feature: Unauthorized HomeFellowshipEntity Redirect
# % protected region % [Override feature properties here] end

@HomeFellowshipEntity
Scenario: Unauthorized HomeFellowshipEntity Redirect
Given I am logged out of the site
And I navigate to the HomeFellowshipEntity backend page
Then I assert that I am redirected from HomeFellowshipEntity to login page
