...
Feature: Unauthorized ProtocolEntity Redirect
# % protected region % [Override feature properties here] end

@ProtocolEntity
Scenario: Unauthorized ProtocolEntity Redirect
Given I am logged out of the site
And I navigate to the ProtocolEntity backend page
Then I assert that I am redirected from ProtocolEntity to login page
