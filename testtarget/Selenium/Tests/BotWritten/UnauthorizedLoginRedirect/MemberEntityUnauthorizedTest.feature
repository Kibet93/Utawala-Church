...
Feature: Unauthorized MemberEntity Redirect
# % protected region % [Override feature properties here] end

@MemberEntity
Scenario: Unauthorized MemberEntity Redirect
Given I am logged out of the site
And I navigate to the MemberEntity backend page
Then I assert that I am redirected from MemberEntity to login page
