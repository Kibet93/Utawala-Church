...
Feature: Unauthorized MembersEntity Redirect
# % protected region % [Override feature properties here] end

@MembersEntity
Scenario: Unauthorized MembersEntity Redirect
Given I am logged out of the site
And I navigate to the MembersEntity backend page
Then I assert that I am redirected from MembersEntity to login page
