...
Feature: Unauthorized CategoryLeadersEntity Redirect
# % protected region % [Override feature properties here] end

@CategoryLeadersEntity
Scenario: Unauthorized CategoryLeadersEntity Redirect
Given I am logged out of the site
And I navigate to the CategoryLeadersEntity backend page
Then I assert that I am redirected from CategoryLeadersEntity to login page
