...
@BotWritten @Filter
Feature: HomeFellowshipEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@HomeFellowshipEntity
Scenario: HomeFellowshipEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid HomeFellowshipEntity entities
And I navigate to the HomeFellowshipEntity backend page
When I click the filter Button on the HomeFellowshipEntity page
