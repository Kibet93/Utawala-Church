...
@BotWritten @Filter
Feature: UsherEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@UsherEntity
Scenario: UsherEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid UsherEntity entities
And I navigate to the UsherEntity backend page
When I click the filter Button on the UsherEntity page
