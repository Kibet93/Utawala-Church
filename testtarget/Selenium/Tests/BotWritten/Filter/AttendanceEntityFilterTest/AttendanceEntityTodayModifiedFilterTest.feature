...
@BotWritten @Filter
Feature: AttendanceEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@AttendanceEntity
Scenario: AttendanceEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid AttendanceEntity entities
And I navigate to the AttendanceEntity backend page
When I click the filter Button on the AttendanceEntity page
