...
@BotWritten @Filter
Feature: ProtocolEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@ProtocolEntity
Scenario: ProtocolEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid ProtocolEntity entities
And I navigate to the ProtocolEntity backend page
When I click the filter Button on the ProtocolEntity page
