...
@BotWritten @Filter
Feature: GroupCategoryEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@GroupCategoryEntity
Scenario: GroupCategoryEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid GroupCategoryEntity entities
And I navigate to the GroupCategoryEntity backend page
When I click the filter Button on the GroupCategoryEntity page
