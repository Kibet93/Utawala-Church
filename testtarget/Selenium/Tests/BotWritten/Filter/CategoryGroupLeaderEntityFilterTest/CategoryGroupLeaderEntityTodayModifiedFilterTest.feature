...
@BotWritten @Filter
Feature: CategoryGroupLeaderEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@CategoryGroupLeaderEntity
Scenario: CategoryGroupLeaderEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid CategoryGroupLeaderEntity entities
And I navigate to the CategoryGroupLeaderEntity backend page
When I click the filter Button on the CategoryGroupLeaderEntity page
