...
@BotWritten @Filter
Feature: AccountabilityGroupEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@AccountabilityGroupEntity
Scenario: AccountabilityGroupEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid AccountabilityGroupEntity entities
And I navigate to the AccountabilityGroupEntity backend page
When I click the filter Button on the AccountabilityGroupEntity page
