...
@BotWritten @Filter
Feature: ServicesEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@ServicesEntity
Scenario: ServicesEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid ServicesEntity entities
And I navigate to the ServicesEntity backend page
When I click the filter Button on the ServicesEntity page
