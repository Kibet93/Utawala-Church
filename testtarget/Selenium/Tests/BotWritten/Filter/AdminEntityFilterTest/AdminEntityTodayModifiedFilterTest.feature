...
@BotWritten @Filter
Feature: AdminEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@AdminEntity
Scenario: AdminEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid AdminEntity entities
And I navigate to the AdminEntity backend page
When I click the filter Button on the AdminEntity page
