...
Feature: Sort UsherEntity
	@UsherEntity
	Scenario: Sort UsherEntity
	Given I login to the site as a user
	And I navigate to the UsherEntity backend page
	When I sort UsherEntity by Member ID
	Then I assert that Member ID in UsherEntity of type int is properly sorted in descending
	When I sort UsherEntity by Member ID
	Then I assert that Member ID in UsherEntity of type int is properly sorted in ascending
