...
@BotWritten @pages
Feature: SeatBookingPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@SeatBookingPage
Scenario: Check contents of SeatBookingPage page
Given I login to the site as a user
And I navigate to the SeatBookingPage frontend page
Then The contents of the SeatBookingPage is correct
