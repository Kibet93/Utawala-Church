...
@BotWritten @pages
Feature: BookingPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@BookingPage
Scenario: Check contents of BookingPage page
Given I login to the site as a user
And I navigate to the BookingPage frontend page
Then The contents of the BookingPage is correct
