...
@BotWritten @pages
Feature: RegisteredMembersPage Contents Feature
...
Scenario: Check contents of RegisteredMembersPage page
Given I login to the site as a user
And I navigate to the RegisteredMembersPage frontend page
Then The contents of the RegisteredMembersPage is correct
