...
@BotWritten @pages
Feature: HomePage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@HomePage
Scenario: Check contents of HomePage page
Given I login to the site as a user
And I navigate to the HomePage frontend page
Then The contents of the HomePage is correct
