...
Feature: Delete all GroupCategoryEntity on all pages
# % protected region % [Override feature properties here] end
	@GroupCategoryEntity
	Scenario: Delete all GroupCategoryEntity on all pages
	Given I have 15 valid GroupCategoryEntity entities
