...
Feature: Delete all AccountabilityGroupEntity on all pages
# % protected region % [Override feature properties here] end
	@AccountabilityGroupEntity
	Scenario: Delete all AccountabilityGroupEntity on all pages
	Given I have 15 valid AccountabilityGroupEntity entities
