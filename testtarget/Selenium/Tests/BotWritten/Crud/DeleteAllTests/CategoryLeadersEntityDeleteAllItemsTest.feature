...
Feature: Delete all CategoryLeadersEntity on all pages
# % protected region % [Override feature properties here] end
	@CategoryLeadersEntity
	Scenario: Delete all CategoryLeadersEntity on all pages
	Given I have 15 valid CategoryLeadersEntity entities
