...
Feature: Delete all HomeFellowshipEntity on all pages
# % protected region % [Override feature properties here] end
	@HomeFellowshipEntity
	Scenario: Delete all HomeFellowshipEntity on all pages
	Given I have 15 valid HomeFellowshipEntity entities
