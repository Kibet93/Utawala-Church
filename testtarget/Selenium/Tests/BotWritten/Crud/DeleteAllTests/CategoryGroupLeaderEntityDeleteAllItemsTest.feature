...
Feature: Delete all CategoryGroupLeaderEntity on all pages
# % protected region % [Override feature properties here] end
	@CategoryGroupLeaderEntity
	Scenario: Delete all CategoryGroupLeaderEntity on all pages
	Given I have 15 valid CategoryGroupLeaderEntity entities
