...
Feature: Delete all AccountabilityGroupsEntity on all pages
# % protected region % [Override feature properties here] end
	@AccountabilityGroupsEntity
	Scenario: Delete all AccountabilityGroupsEntity on all pages
	Given I have 15 valid AccountabilityGroupsEntity entities
