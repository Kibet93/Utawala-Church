...
# % protected region % [Override test content here] off begin
	...
	And I navigate to the AdminEntity admin crud page
	When I insert a valid AdminEntity, search for it and update
	Then I assert that I am on the AdminEntity admin crud page
	Then I assert a toaster alert is displayed with the message: Successfully edited Admin
