...
@BotWritten @view
Feature: View readonly ProtocolEntity
# % protected region % [Override feature properties here] end
# % protected region % [Override test contents here] off begin
	@ProtocolEntity
	Scenario: View ProtocolEntity
	Given I login to the site as a user
	And I insert a ProtocolEntity into the database
	And I navigate to the ProtocolEntity admin crud page
	When I click View on the first ProtocolEntity in the crud list
	Then I assert that I am viewing a ProtocolEntity on the ProtocolEntity view page
