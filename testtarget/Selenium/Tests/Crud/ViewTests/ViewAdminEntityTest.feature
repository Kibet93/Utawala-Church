...
# % protected region % [Override test contents here] off begin
	@AdminEntity
	Scenario: View AdminEntity
	Given I login to the site as a user
	And I insert a AdminEntity into the database
	And I navigate to the AdminEntity admin crud page
	When I click View on the first AdminEntity in the crud list
	Then I assert that I am viewing a AdminEntity on the AdminEntity view page
