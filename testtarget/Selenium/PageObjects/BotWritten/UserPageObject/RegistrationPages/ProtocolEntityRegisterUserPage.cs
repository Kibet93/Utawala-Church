...
{
	public class RegisterProtocolEntityUserPage : RegisterUserBasePage
	{
		public override string Url => baseUrl + "/login";

		public RegisterProtocolEntityUserPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
