...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class ProtocolEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly ProtocolEntity _protocolEntity;
		...
		public ProtocolEntityDetailSection(ContextConfiguration contextConfiguration, ProtocolEntity protocolEntity = null) : base(contextConfiguration)
		{
		...
		public void Apply()
		{
			...
			SetMemberID(_protocolEntity.MemberID);

			SetMemberId(_protocolEntity.MemberId.ToString());

			if (_driver.Url == $"{_contextConfiguration.BaseUrl}/admin/protocolentity/create")
			{
				SetUserFields(_protocolEntity);
			}
		...
		private void SetUserFields(ProtocolEntity protocolEntity)
		{
			UserEmailElement.SendKeys(protocolEntity.EmailAddress);
			UserPasswordElement.SendKeys(protocolEntity.Password);
			UserConfirmPasswordElement.SendKeys(protocolEntity.Password);
		}
