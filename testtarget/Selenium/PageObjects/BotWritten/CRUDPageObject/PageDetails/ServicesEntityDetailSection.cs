...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class ServicesEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly ServicesEntity _servicesEntity;
		...
		public ServicesEntityDetailSection(ContextConfiguration contextConfiguration, ServicesEntity servicesEntity = null) : base(contextConfiguration)
		{
		...
		public void Apply()
		{
			...
			SetDateOfService(_servicesEntity.DateOfService);
			SetName(_servicesEntity.Name);
