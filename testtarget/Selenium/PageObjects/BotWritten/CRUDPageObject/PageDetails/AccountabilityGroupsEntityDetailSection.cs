...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class AccountabilityGroupsEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly AccountabilityGroupsEntity _accountabilityGroupsEntity;
		...
		public AccountabilityGroupsEntityDetailSection(ContextConfiguration contextConfiguration, AccountabilityGroupsEntity accountabilityGroupsEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_accountabilityGroupsEntity = accountabilityGroupsEntity;
		...
		public void Apply()
		{
			...
			SetName(_accountabilityGroupsEntity.Name);
			SetCategory(_accountabilityGroupsEntity.Category);
			SetLeaderID(_accountabilityGroupsEntity.LeaderID);

			if (_accountabilityGroupsEntity.MembersaccountabilitygroupIds != null)
			{
				SetMembersaccountabilitygroups(_accountabilityGroupsEntity.MembersaccountabilitygroupIds.Select(x => x.ToString()));
			}
