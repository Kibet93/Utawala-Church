...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class NoOfServiceEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly NoOfServiceEntity _noOfServiceEntity;
		...
		public NoOfServiceEntityDetailSection(ContextConfiguration contextConfiguration, NoOfServiceEntity noOfServiceEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_noOfServiceEntity = noOfServiceEntity;
		...
		public void Apply()
		{
			...
			SetName(_noOfServiceEntity.Name);
			SetStatus(_noOfServiceEntity.Status);
