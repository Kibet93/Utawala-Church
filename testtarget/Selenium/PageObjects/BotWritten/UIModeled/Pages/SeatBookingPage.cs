...
{
	public class SeatBookingPage : UIModeledPage
	{
		// % protected region % [Override class properties here] off begin
		public override string Url => baseUrl + "/seatbooking";
		private const string RootSelector = "//div[@class='body-content']";
		private By HeadingComponentBy => By.XPath($"{RootSelector}//h1[text()='Seat Bookings']");
		private By ParagraphBy => By.XPath($"{RootSelector}//p[text()='Reserve your seat prior to the service']");
		private By FormComponentBy => By.XPath($"{RootSelector}//div[@class = 'form-submission-tile']");
		// % protected region % [Override class properties here] end
		// % protected region % [Override constructor here] off begin
		public SeatBookingPage(ContextConfiguration currentContext) : base(currentContext)
		{
		}
		...
		public override bool ContainsModeledElements()
		{
			...
			validContents &= WaitUtils.elementState(DriverWait, FormComponentBy, ElementState.VISIBLE);
