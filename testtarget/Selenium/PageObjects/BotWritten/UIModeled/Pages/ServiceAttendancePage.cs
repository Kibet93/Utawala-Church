...
{
	public class ServiceAttendancePage : UIModeledPage
	{
		// % protected region % [Override class properties here] off begin
		public override string Url => baseUrl + "/serviceattendance";
		private const string RootSelector = "//div[@class='body-content']";
		private By HeadingComponentBy => By.XPath($"{RootSelector}//h1[text()='Sunday Services']");
		private By CrudComponentBy => By.XPath($"{RootSelector}//section[@class='collection-component']");
		// % protected region % [Override class properties here] end
		// % protected region % [Override constructor here] off begin
		public ServiceAttendancePage(ContextConfiguration currentContext) : base(currentContext)
		{
		}
