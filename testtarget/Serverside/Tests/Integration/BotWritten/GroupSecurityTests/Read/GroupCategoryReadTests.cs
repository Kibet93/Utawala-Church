...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Read
{
	...
	public class GroupCategoryReadTests : BaseReadTest
	{

		public GroupCategoryReadTests()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, bool, string> GroupCategoryReadSecurityData 
		{
			get
			{
				var data = new TheoryData<IAbstractModel, bool, string>
				{
					...
					{new WorkflowEntity(), true, "GroupCategory"},
					{new WorkflowStateEntity(), true, "GroupCategory"},
					{new WorkflowTransitionEntity(), true, "GroupCategory"},
					{new WorkflowVersionEntity(), true, "GroupCategory"},
					{new MemberSubmissionEntity(), true, "GroupCategory"},
		...
		[Theory]
		[MemberData(nameof(GroupCategoryReadSecurityData))]
		public async Task GroupCategoryReadSecurityTests<T>(T entity, bool canRead, string groupName)
