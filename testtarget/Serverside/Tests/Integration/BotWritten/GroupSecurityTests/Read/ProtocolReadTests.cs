...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Read
{
	...
	public class ProtocolReadTests : BaseReadTest
	{

		public ProtocolReadTests()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, bool, string> ProtocolReadSecurityData 
		{
			get
			{
		...
		[Theory]
		[MemberData(nameof(ProtocolReadSecurityData))]
		public async Task ProtocolReadSecurityTests<T>(T entity, bool canRead, string groupName)
