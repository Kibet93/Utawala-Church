...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Read
{
	...
	public class MemberReadTests : BaseReadTest
	{

		public MemberReadTests()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, bool, string> MemberReadSecurityData 
		{
			get
			{
				var data = new TheoryData<IAbstractModel, bool, string>
				{
					...
					{new AccountabilityGroupEntity(), true, "Member"},
					{new NoOfServiceEntity(), true, "Member"},
					{new AttendanceEntity(), true, "Member"},
					{new HomeFellowshipEntity(), true, "Member"},
					{new SeatsEntity(), false, null},
					{new ServicesEntity(), false, null},
					{new WorkflowEntity(), true, "Member"},
					{new WorkflowStateEntity(), true, "Member"},
					{new WorkflowTransitionEntity(), true, "Member"},
					{new WorkflowVersionEntity(), true, "Member"},
					{new MemberSubmissionEntity(), true, "Member"},
					{new MemberEntityFormTileEntity(), true, "Member"},
		...
		[Theory]
		[MemberData(nameof(MemberReadSecurityData))]
		public async Task MemberReadSecurityTests<T>(T entity, bool canRead, string groupName)
