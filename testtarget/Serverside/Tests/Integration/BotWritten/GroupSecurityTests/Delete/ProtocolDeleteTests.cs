...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Delete
{
	...
	public class ProtocolDeleteTest : BaseDeleteTest
	{
		public ProtocolDeleteTest()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, string, string> DeleteProtocolSecurityData 
		{
			get
			{
		...
		[Theory]
		[MemberData(nameof(DeleteProtocolSecurityData))]
		public async Task ProtocolDeleteSecurity<T>(T model, string message, string groupName)
