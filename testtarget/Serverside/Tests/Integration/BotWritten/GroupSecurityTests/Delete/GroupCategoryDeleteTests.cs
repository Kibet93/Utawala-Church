...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Delete
{
	...
	public class GroupCategoryDeleteTest : BaseDeleteTest
	{
		public GroupCategoryDeleteTest()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, string, string> DeleteGroupCategorySecurityData 
		{
			get
			{
		...
		[Theory]
		[MemberData(nameof(DeleteGroupCategorySecurityData))]
		public async Task GroupCategoryDeleteSecurity<T>(T model, string message, string groupName)
