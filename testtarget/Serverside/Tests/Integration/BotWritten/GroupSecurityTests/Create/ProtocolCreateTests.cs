		...
		public static TheoryData<IAbstractModel, object, string, string> ProtocolCreateUserSecurityData
		{
			get
			{
				var data = new TheoryData<IAbstractModel, object, string, string>
				{
					...
					{new CategoryLeadersEntity(), new CategoryLeadersEntityGraphQlRegistrationModel(), null, "Protocol"},
					{new MembersEntity(), new MembersEntityGraphQlRegistrationModel(), null, "Protocol"},
					{new AdminEntity(), new AdminEntityGraphQlRegistrationModel(), null, "Protocol"},
					{new ProtocolEntity(), new ProtocolEntityGraphQlRegistrationModel(), null, "Protocol"},
					{new UsherEntity(), new UsherEntityGraphQlRegistrationModel(), null, "Protocol"},
