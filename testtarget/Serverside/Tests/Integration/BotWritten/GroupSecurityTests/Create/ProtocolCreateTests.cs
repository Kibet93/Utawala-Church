...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Create
{
	...
	public class ProtocolCreateTest : BaseCreateTest
	{

		public ProtocolCreateTest()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, string, string> ProtocolCreateSecurityData 
		{
			get
			{
				var data = new TheoryData<IAbstractModel, string,string>
				{
					...
					{new MemberEntityFormTileEntity(), null, "Protocol"},
		...
		[Theory]
		[MemberData(nameof(ProtocolCreateSecurityData))]
		public async Task ProtocolCreateTests<T>(T model, string message, string groupName)
		...
		public static TheoryData<IAbstractModel, object, string, string> ProtocolCreateUserSecurityData
		{
			get
			{
				var data = new TheoryData<IAbstractModel, object, string, string>
				{
					// % protected region % [Configure user theory data for Protocol here] off begin
					{new CategoryGroupLeaderEntity(), new CategoryGroupLeaderEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Protocol"},
					{new GroupCategoryEntity(), new GroupCategoryEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Protocol"},
					{new MemberEntity(), new MemberEntityGraphQlRegistrationModel(), null, "Protocol"},
					{new AdminEntity(), new AdminEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Protocol"},
					{new ProtocolEntity(), new ProtocolEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Protocol"},
					{new UsherEntity(), new UsherEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Protocol"},
					// % protected region % [Configure user theory data for Protocol here] end
				};
		...
		[Theory]
		[MemberData(nameof(ProtocolCreateUserSecurityData))]
		public async Task ProtocolCreateUserTests<T, TDto>(T model, TDto dto, string message, string groupName)
