...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Create
{
	...
	public class MemberCreateTest : BaseCreateTest
	{

		public MemberCreateTest()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, string, string> MemberCreateSecurityData 
		{
			get
			{
		...
		[Theory]
		[MemberData(nameof(MemberCreateSecurityData))]
		public async Task MemberCreateTests<T>(T model, string message, string groupName)
		...
		public static TheoryData<IAbstractModel, object, string, string> MemberCreateUserSecurityData
		{
			get
			{
				var data = new TheoryData<IAbstractModel, object, string, string>
				{
					// % protected region % [Configure user theory data for Member here] off begin
					{new CategoryGroupLeaderEntity(), new CategoryGroupLeaderEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Member"},
					{new GroupCategoryEntity(), new GroupCategoryEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Member"},
					{new MemberEntity(), new MemberEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Member"},
					{new AdminEntity(), new AdminEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Member"},
					{new ProtocolEntity(), new ProtocolEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Member"},
					{new UsherEntity(), new UsherEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, "Member"},
					// % protected region % [Configure user theory data for Member here] end
				};
		...
		[Theory]
		[MemberData(nameof(MemberCreateUserSecurityData))]
		public async Task MemberCreateUserTests<T, TDto>(T model, TDto dto, string message, string groupName)
