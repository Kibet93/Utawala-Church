...
namespace Utawalaaltar.Models {
	public class MemberEntityConfiguration : IEntityTypeConfiguration<MemberEntity>
	{
		public void Configure(EntityTypeBuilder<MemberEntity> builder)
		{
			...
			// % protected region % [Override GroupCategory Memberscategoriess configuration here] off begin
			builder
				.HasOne(e => e.GroupCategory)
				.WithMany(e => e.Memberscategoriess)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override GroupCategory Memberscategoriess configuration here] end
			...
			builder
				...
				.WithOne(e => e.Member)
				.HasForeignKey<CategoryGroupLeaderEntity>(e => e.MemberId)
				.OnDelete(DeleteBehavior.Restrict);
