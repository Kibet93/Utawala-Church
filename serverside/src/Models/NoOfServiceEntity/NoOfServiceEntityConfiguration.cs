...
namespace Utawalaaltar.Models {
	public class NoOfServiceEntityConfiguration : IEntityTypeConfiguration<NoOfServiceEntity>
	{
		public void Configure(EntityTypeBuilder<NoOfServiceEntity> builder)
		{
