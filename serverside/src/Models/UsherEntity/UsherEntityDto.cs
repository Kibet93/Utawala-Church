...
{
	public class UsherEntityDto : ModelDto<UsherEntity>
	{
		...
		public UsherEntityDto(UsherEntity model)
		{
			LoadModelData(model);
		...
		public override ModelDto<UsherEntity> LoadModelData(UsherEntity model)
		{
			Id = model.Id;
