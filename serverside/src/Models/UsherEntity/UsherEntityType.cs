...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class UsherEntityType : ObjectGraphType<UsherEntity>
	{
		public UsherEntityType()
		{
			...
			Field<MembersEntityType, MembersEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, MembersEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetMemberForUsherEntity",
						async keys =>
						{
	...
	/// </summary>
	public class UsherEntityInputType : InputObjectGraphType<UsherEntity>
	{
		public UsherEntityInputType()
		{
			Name = "UsherEntityInput";
			Description = "The input object for adding a new UsherEntity";
	...
	/// </summary>
	public class UsherEntityCreateInputType : InputObjectGraphType<UsherEntity>
	{
		public UsherEntityCreateInputType()
		{
			Name = "UsherEntityCreateInput";
			Description = "The input object for creating a new UsherEntity";
