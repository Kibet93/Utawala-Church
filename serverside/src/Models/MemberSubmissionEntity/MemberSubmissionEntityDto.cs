...
{
	/// <summary>
	/// The MEMBER submission form entity
	/// </summary>
	public class MemberSubmissionEntityDto : ModelDto<MemberSubmissionEntity>
	{
		...
		public MemberSubmissionEntityDto(MemberSubmissionEntity model)
		{
			LoadModelData(model);
		...
		public MemberSubmissionEntityDto()
		{
		...
		public override ModelDto<MemberSubmissionEntity> LoadModelData(MemberSubmissionEntity model)
		{
			Id = model.Id;
