...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class AttendanceSubmissionEntityType : ObjectGraphType<AttendanceSubmissionEntity>
	{
		public AttendanceSubmissionEntityType()
		{
			Description = @"The Attendance submission form entity";
			...
			Field<AttendanceEntityFormVersionType, AttendanceEntityFormVersion>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, AttendanceEntityFormVersion>(
						"GetFormVersionForAttendanceSubmissionEntity",
						async keys =>
						{
	...
	/// </summary>
	public class AttendanceSubmissionEntityInputType : InputObjectGraphType<AttendanceSubmissionEntity>
	{
		public AttendanceSubmissionEntityInputType()
		{
			Name = "AttendanceSubmissionEntityInput";
			Description = "The input object for adding a new AttendanceSubmissionEntity";
