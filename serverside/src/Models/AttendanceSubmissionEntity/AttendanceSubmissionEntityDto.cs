...
{
	/// <summary>
	/// The Attendance submission form entity
	/// </summary>
	public class AttendanceSubmissionEntityDto : ModelDto<AttendanceSubmissionEntity>
	{
		...
		public AttendanceSubmissionEntityDto(AttendanceSubmissionEntity model)
		{
			LoadModelData(model);
		...
		public AttendanceSubmissionEntityDto()
		{
		...
		public override ModelDto<AttendanceSubmissionEntity> LoadModelData(AttendanceSubmissionEntity model)
		{
			Id = model.Id;
