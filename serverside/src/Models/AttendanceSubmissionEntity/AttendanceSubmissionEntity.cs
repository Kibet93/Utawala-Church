...
namespace Utawalaaltar.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(AttendanceEntityFormVersion))]
		public AttendanceEntityFormVersion FormVersion { get; set; }
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<AttendanceSubmissionEntity>().ToList();
