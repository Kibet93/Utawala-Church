...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class GroupCategoryEntityDto : ModelDto<GroupCategoryEntity>
	{
		...
		public GroupCategoryEntityDto(GroupCategoryEntity model)
		{
			LoadModelData(model);
		...
		public override GroupCategoryEntity ToModel()
		{
			...
			return new GroupCategoryEntity
			{
				Id = Id,
				Created = Created,
				Modified = Modified,
		...
		public override ModelDto<GroupCategoryEntity> LoadModelData(GroupCategoryEntity model)
		{
			Id = model.Id;
