...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class MemberEntityFormTileEntityType : ObjectGraphType<MemberEntityFormTileEntity>
	{
		public MemberEntityFormTileEntityType()
		{
			...
			// GraphQL reference to entity MemberEntity via reference Form
			Field<MemberEntityType, MemberEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, MemberEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetFormForMemberEntityFormTileEntity",
						async keys =>
						{
	...
	/// </summary>
	public class MemberEntityFormTileEntityInputType : InputObjectGraphType<MemberEntityFormTileEntity>
	{
		public MemberEntityFormTileEntityInputType()
		{
			Name = "MemberEntityFormTileEntityInput";
			Description = "The input object for adding a new MemberEntityFormTileEntity";
			...
			Field<MemberEntityInputType>("Form");
