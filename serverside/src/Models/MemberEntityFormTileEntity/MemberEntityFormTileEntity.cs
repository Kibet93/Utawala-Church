...
namespace Utawalaaltar.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		// % protected region % [Customise Form here] off begin
		/// <summary>
		/// Outgoing one to many reference
		/// </summary>
		/// <see cref="Utawalaaltar.Models.MemberEntity"/>
		public Guid FormId { get; set; }
		[EntityForeignKey("Form", "FormPages", true, typeof(MemberEntity))]
		public MemberEntity Form { get; set; }
		// % protected region % [Customise Form here] end
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<MemberEntityFormTileEntity>().ToList();
