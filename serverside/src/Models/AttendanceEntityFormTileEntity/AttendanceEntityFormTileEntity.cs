...
namespace Utawalaaltar.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(AttendanceEntity))]
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<AttendanceEntityFormTileEntity>().ToList();
