...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class AttendanceEntityFormTileEntityType : ObjectGraphType<AttendanceEntityFormTileEntity>
	{
		public AttendanceEntityFormTileEntityType()
		{
			...
			// GraphQL reference to entity AttendanceEntity via reference Form
			Field<AttendanceEntityType, AttendanceEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, AttendanceEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetFormForAttendanceEntityFormTileEntity",
						async keys =>
						{
	...
	/// </summary>
	public class AttendanceEntityFormTileEntityInputType : InputObjectGraphType<AttendanceEntityFormTileEntity>
	{
		public AttendanceEntityFormTileEntityInputType()
		{
			Name = "AttendanceEntityFormTileEntityInput";
			Description = "The input object for adding a new AttendanceEntityFormTileEntity";
			...
			Field<AttendanceEntityInputType>("Form");
