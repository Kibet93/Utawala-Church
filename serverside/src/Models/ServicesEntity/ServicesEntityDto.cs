...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class ServicesEntityDto : ModelDto<ServicesEntity>
	{
		...
		public ServicesEntityDto(ServicesEntity model)
		{
			LoadModelData(model);
		...
		public override ServicesEntity ToModel()
		{
		...
		public override ModelDto<ServicesEntity> LoadModelData(ServicesEntity model)
		{
			Id = model.Id;
