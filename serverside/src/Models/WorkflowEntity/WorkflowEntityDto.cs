...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class WorkflowEntityDto : ModelDto<WorkflowEntity>
	{
		...
		// % protected region % [Customise CurrentVersionId here] off begin
		public Guid? CurrentVersionId { get; set; }
		// % protected region % [Customise CurrentVersionId here] end
		...
		public override WorkflowEntity ToModel()
		{
		...
		public override ModelDto<WorkflowEntity> LoadModelData(WorkflowEntity model)
		{
			Id = model.Id;
