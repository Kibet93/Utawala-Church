...
{
	public class AccountabilityGroupEntityDto : ModelDto<AccountabilityGroupEntity>
	{
		...
		public AccountabilityGroupEntityDto(AccountabilityGroupEntity model)
		{
			LoadModelData(model);
		...
		public AccountabilityGroupEntityDto()
		{
		...
		public override ModelDto<AccountabilityGroupEntity> LoadModelData(AccountabilityGroupEntity model)
		{
			Id = model.Id;
