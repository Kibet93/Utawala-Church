...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class AccountabilityGroupEntityType : ObjectGraphType<AccountabilityGroupEntity>
	{
		public AccountabilityGroupEntityType()
		{
			...
			// GraphQL reference to entity MemberEntity via reference Membersaccountabilitygroup
			Field<ListGraphType<NonNullGraphType<MemberEntityType>>, IEnumerable<MemberEntity>>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddCollectionBatchLoader<Guid?, MemberEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetMembersaccountabilitygroupsForAccountabilityGroupEntity",
						async keys =>
						{
	...
	/// </summary>
	public class AccountabilityGroupEntityInputType : InputObjectGraphType<AccountabilityGroupEntity>
	{
		public AccountabilityGroupEntityInputType()
		{
			Name = "AccountabilityGroupEntityInput";
			Description = "The input object for adding a new AccountabilityGroupEntity";
			...
			Field<ListGraphType<MemberEntityInputType>>("Membersaccountabilitygroups");
