...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class CategoryLeadersEntityType : ObjectGraphType<CategoryLeadersEntity>
	{
		public CategoryLeadersEntityType()
		{
			...
			Field(o => o.CategoryGroup, type: typeof(EnumerationGraphType<CategoryGroups>));
			...
			Field<MembersEntityType, MembersEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, MembersEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetMemberForCategoryLeadersEntity",
						async keys =>
						{
	...
	/// </summary>
	public class CategoryLeadersEntityInputType : InputObjectGraphType<CategoryLeadersEntity>
	{
		public CategoryLeadersEntityInputType()
		{
			Name = "CategoryLeadersEntityInput";
			Description = "The input object for adding a new CategoryLeadersEntity";

			// Add entity fields
			Field<IdGraphType>("Id");
			Field<DateTimeGraphType>("Created");
			Field<DateTimeGraphType>("Modified");
			Field<EnumerationGraphType<CategoryGroups>>("CategoryGroup");
	...
	/// </summary>
	public class CategoryLeadersEntityCreateInputType : InputObjectGraphType<CategoryLeadersEntity>
	{
		public CategoryLeadersEntityCreateInputType()
		{
			Name = "CategoryLeadersEntityCreateInput";
			Description = "The input object for creating a new CategoryLeadersEntity";
