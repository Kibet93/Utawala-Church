...
namespace Utawalaaltar.Models {
	...
	public class WorkflowTransitionEntity : IOwnerAbstractModel 
	// % protected region % [Modify class declaration here] end
	{
		...
		/// </summary>
		[Required]
		// % protected region % [Customise TransitionName here] off begin
		[EntityAttribute]
		public String TransitionName { get; set; }
		// % protected region % [Customise TransitionName here] end
		...
		// % protected region % [Customise SourceState here] off begin
		/// <summary>
		/// Outgoing one to many reference
		/// </summary>
		/// <see cref="Utawalaaltar.Models.WorkflowStateEntity"/>
		public Guid SourceStateId { get; set; }
		[EntityForeignKey("SourceState", "OutgoingTransitionss", true, typeof(WorkflowStateEntity))]
		public WorkflowStateEntity SourceState { get; set; }
		// % protected region % [Customise SourceState here] end

		// % protected region % [Customise TargetState here] off begin
		/// <summary>
		/// Outgoing one to many reference
		/// </summary>
		/// <see cref="Utawalaaltar.Models.WorkflowStateEntity"/>
		public Guid TargetStateId { get; set; }
		[EntityForeignKey("TargetState", "IncomingTransitionss", true, typeof(WorkflowStateEntity))]
		public WorkflowStateEntity TargetState { get; set; }
		// % protected region % [Customise TargetState here] end
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<WorkflowTransitionEntity>().ToList();
