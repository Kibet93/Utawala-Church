...
namespace Utawalaaltar.Models
{
	...
	/// </summary>
	public class WorkflowTransitionEntityDto : ModelDto<WorkflowTransitionEntity>
	{
		...
		// % protected region % [Customise SourceStateId here] off begin
		public Guid SourceStateId { get; set; }
		// % protected region % [Customise SourceStateId here] end

		// % protected region % [Customise TargetStateId here] off begin
		public Guid TargetStateId { get; set; }
		// % protected region % [Customise TargetStateId here] end
		...
		public WorkflowTransitionEntityDto()
		{
		...
		public override WorkflowTransitionEntity ToModel()
		{
		...
		public override ModelDto<WorkflowTransitionEntity> LoadModelData(WorkflowTransitionEntity model)
		{
			Id = model.Id;
