...
namespace Utawalaaltar.Controllers
{
	...
	public class FileController : BaseApiController
	{
			...
			)
		{
			...
			try
			{
				file = await _crudService.GetFile(id, cancellation: cancellationToken);
		...
		public async Task<IActionResult> Metadata(
			Guid id, 
			CancellationToken cancellationToken
			// % protected region % [Add any extra metadata arguments here] off begin
			// % protected region % [Add any extra metadata arguments here] end
			)
		{
