...
{
	/// <summary>
	/// Security listing for the Usher group for the AccountabilityGroupsEntity scheme
	/// </summary>
	public class UsherAccountabilityGroupsEntity : IAcl
	{
		public string Group => "Usher";
