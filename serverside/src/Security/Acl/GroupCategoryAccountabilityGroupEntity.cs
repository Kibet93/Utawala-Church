...
{
	/// <summary>
	/// Security listing for the GroupCategory group for the AccountabilityGroupEntity scheme
	/// </summary>
	public class GroupCategoryAccountabilityGroupEntity : IAcl
	{
		public string Group => "GroupCategory";
