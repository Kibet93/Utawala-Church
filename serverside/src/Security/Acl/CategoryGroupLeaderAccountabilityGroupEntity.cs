...
{
	/// <summary>
	/// Security listing for the CategoryGroupLeader group for the AccountabilityGroupEntity scheme
	/// </summary>
	public class CategoryGroupLeaderAccountabilityGroupEntity : IAcl
	{
