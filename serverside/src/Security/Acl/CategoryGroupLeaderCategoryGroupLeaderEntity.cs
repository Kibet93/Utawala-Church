...
namespace Utawalaaltar.Security.Acl
{
	/// <summary>
	/// Security listing for the CategoryGroupLeader group for the CategoryGroupLeaderEntity scheme
	/// </summary>
	public class CategoryGroupLeaderCategoryGroupLeaderEntity : IAcl
	{
		public string Group => "CategoryGroupLeader";
