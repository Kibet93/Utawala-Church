...
{
	/// <summary>
	/// Security listing for the Protocol group for the AccountabilityGroupsEntity scheme
	/// </summary>
	public class ProtocolAccountabilityGroupsEntity : IAcl
	{
		public string Group => "Protocol";
