...
{
	/// <summary>
	/// Security listing for the Member group for the CategoryGroupLeaderEntity scheme
	/// </summary>
	public class MemberCategoryGroupLeaderEntity : IAcl
	{
		public string Group => "Member";
