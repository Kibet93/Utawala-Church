...
{
	/// <summary>
	/// Security listing for the CategoryLeaders group for the AccountabilityGroupsEntity scheme
	/// </summary>
	public class CategoryLeadersAccountabilityGroupsEntity : IAcl
	{
		public string Group => "CategoryLeaders";
