...
namespace Utawalaaltar.Services
{
	...
	{
		private static readonly IExecutionStrategy SerialExecutionStrategy = new SerialExecutionStrategy();
		private static readonly IExecutionStrategy SubscriptionExecutionStrategy = new SubscriptionExecutionStrategy();
		...
		{
			// % protected region % [Override SelectExecutionStrategy here] off begin
			...
			// % protected region % [Override SelectExecutionStrategy here] end
		}
	}
}