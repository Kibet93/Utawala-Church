...
{
	public class UtawalaaltarGraphQlContext : Dictionary<string, object>
	{
		public UtawalaaltarDBContext DbContext { get; set; }
	...
	public class GraphQlService : IGraphQlService
	{
		...
		private readonly UtawalaaltarDBContext _dataContext;
		...
		public GraphQlService(
			...
			UtawalaaltarDBContext dataContext,
			...
			CancellationToken cancellation)
		{
			...
			var executionOptions = new ExecutionOptions
			{
				...
				Inputs = variables,
				UserContext = new UtawalaaltarGraphQlContext
				{
