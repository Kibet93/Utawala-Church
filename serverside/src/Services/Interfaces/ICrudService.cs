...
namespace Utawalaaltar.Services.Interfaces
{
	public interface ICrudService
	{
		...
		/// <param name="options">Execution options to control the behaviour for getting data.</param>
		...
		/// <param name="options">Execution options to control the behaviour for getting data.</param>
		/// <returns>A graphql execution result</returns>
		IQueryable<T> GetById<T>(Guid id, ReadOptions options = null) where T : class, IOwnerAbstractModel, new();
		...
		/// <param name="options">Extra options to be passed in for the delete</param>
		/// <param name="cancellation">The cancellation token for this operation</param>
		/// <returns>A graphql execution result</returns>
		Task<Guid> Delete<T>(
			Guid id,
		...
		/// <param name="cancellation">The cancellation token for this operation</param>
		/// <returns>A graphql execution result</returns>
		Task<ICollection<Guid>> Delete<T>(
			List<Guid> ids,
			CrudOptions options = null,
			CancellationToken cancellation = default)
			where T : class, IAbstractModel;
		...
		/// <param name="options">Extra options to be passed in for the get</param>
		/// <param name="cancellation">The cancellation token for this operation</param>
