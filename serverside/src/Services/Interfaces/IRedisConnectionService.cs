...
namespace Utawalaaltar.Services.Interfaces
{
	...
	{
		/// <summary>
		/// Is redis enabled. If this is set to false then <see cref="Connection"/> will be set to null.
		/// </summary>
		bool Enabled { get; }

		/// <summary>
		/// Holds a Redis ConnectionMultiplexer or null if Redis is not enabled.
		/// </summary>
