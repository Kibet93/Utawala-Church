		...
		public static IHostBuilder CreateWebHostBuilder(string[] args) =>
			Host.CreateDefaultBuilder(args)
				...
				.ConfigureAppConfiguration((builderContext, config) =>
				{
					...
					config.AddEnvironmentVariables("Utawalaaltar_");
					config.AddEnvironmentVariables($"Utawalaaltar_{env.EnvironmentName}_");
				...
				.UseSerilog((context, provider, loggerConfiguration) => 
				{
					loggerConfiguration
						...
						.Enrich.WithProperty("Application", "Utawalaaltar")
						.WriteTo.Console();
				})
